...
$ExpectedCandidatePayloadSha256 = '42C72B9F27F51C745E2B8951F9E707C3035DFC22463BFB4D1CF64D21AEE9EE63'
...
function Stop-OwnedLauncherChildren {
    ...
    foreach ($parent in @($Launcher.GameProcess, $Launcher.Process)) {
        ...
        $parentEnd = if ($parent.HasExited) { $parent.ExitTime.ToUniversalTime() } else { [DateTime]::UtcNow }
