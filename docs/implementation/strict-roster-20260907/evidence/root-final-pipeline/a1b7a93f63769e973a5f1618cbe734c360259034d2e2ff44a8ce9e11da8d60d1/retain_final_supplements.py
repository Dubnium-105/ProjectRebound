...
aliases = {
    ...
    counter_dir+'go-test-toolbox-private-counters.log':counter_dir+'go-test-toolbox-helper-counters.log',
    counter_dir+'go-test-toolbox-private-counters-rerun.log':counter_dir+'go-test-toolbox-helper-counters-rerun.log',
    counter_dir+'go-test-toolbox-private-counters-final.log':counter_dir+'go-test-toolbox-helper-counters-final.log',
}
