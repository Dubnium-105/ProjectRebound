...
metadata = {
    ...
    'package_id':'rebound-hardware-test-20260908-r2',
    ...
    'backend_deployment_status':'NOT_UPDATED',
    'backend_observation':{'observed_at_utc':'2026-09-08T03:30:38Z','schema':43,
        'containers':'existing control/meta/PostgreSQL/Redis healthy',
        'candidate_update':'source build aborted due to disk space; CI failed; no migration or container switch',
        'temporary_configuration':'restored with original SHA256'},
...
(base/'public-metadata-r2.json').write_text(json.dumps(metadata,indent=2)+'\n',encoding='utf-8')
