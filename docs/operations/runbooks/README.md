...
| Admin Turnstile, Siteverify, or login-entry failure | [Admin Turnstile login](admin-turnstile-login.md) |
| MetaServer readiness, Logic TLS, Gate replay, matchmaking, or QoS failure | [MetaServer incident](metaserver.md) |
