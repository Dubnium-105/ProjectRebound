...
实现所对应的权威线协议格式见 [`Backend/api/relay-protocol.zh-CN.md`](../../Backend/api/relay-protocol.zh-CN.md)。本页说明客户端和运维侧的兼容边界。
...
故障切换见 [Relay 故障迁移](relay-migration.zh-CN.md)，签名 Keyset 和节点证书见 [Relay 密钥轮换](../operations/key-and-certificate-rotation.zh-CN.md)，异常处置见 [Relay 故障 Runbook](../operations/runbooks/relay-outage.zh-CN.md)。
