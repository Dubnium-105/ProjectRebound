...
func buildHandler(
	...
	router.Group(func(router chi.Router) {
		...
		router.Get("/v1/match-attempts/{attempt_id}/transport", matchLobbyHandler.Transport)
		router.Post("/v1/match-attempts/{attempt_id}/transport/vnt/bootstrap", matchLobbyHandler.TransportVNTBootstrap)
		router.Put("/v1/match-attempts/{attempt_id}/transport/vnt/presence/me", matchLobbyHandler.TransportVNTPresence)
		router.Put("/v1/match-attempts/{attempt_id}/transport/vnt/host-ready", matchLobbyHandler.TransportVNTHostReady)
