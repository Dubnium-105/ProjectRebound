...
try {
    go test ./internal/database ./internal/auth ./internal/admin ./internal/gameserver ./internal/p2proom -run 'Test(Migrator|AuthenticationLifecycle|AdminPlayerLifecycle|GameServerRegistry|P2PRoomLifecycle)AgainstPostgreSQL' -count=1
}
finally {
