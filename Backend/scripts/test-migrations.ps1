...
try {
    go test ./internal/database ./internal/auth ./internal/admin ./internal/gameserver ./internal/p2proom ./internal/connection -run 'Test(Migrator|AuthenticationLifecycle|AdminPlayerLifecycle|GameServerRegistry|P2PRoomLifecycle|ConnectionLifecycle)AgainstPostgreSQL' -count=1
}
finally {
