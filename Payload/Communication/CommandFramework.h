...
public:
    ...
    CommandFramework(const CommandFramework&) = delete;
    CommandFramework& operator=(const CommandFramework&) = delete;
    CommandFramework(CommandFramework&&) = delete;
    CommandFramework& operator=(CommandFramework&&) = delete;

    // Configuration is immutable while the framework is running.
