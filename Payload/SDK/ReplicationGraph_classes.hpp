...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x000230, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x000220, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x000228, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
