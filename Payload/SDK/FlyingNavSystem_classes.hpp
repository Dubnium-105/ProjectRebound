...
static_assert(sizeof(UPathBatchComponent) == 0x0004D0, "Wrong size on UPathBatchComponent");
...
{
public:
	double                                        MaxDetailSize;                                     // 0x0428(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bMultithreaded : 1;                                // 0x0430(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, Config, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_431[0x3];                                      // 0x0431(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EThreadSubdivisions                           ThreadSubdivisions;                                // 0x0434(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_435[0x3];                                      // 0x0435(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxThreads;                                        // 0x0438(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bUseAgentRadius : 1;                               // 0x043C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, Config, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseExclusiveBounds : 1;                           // 0x043C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, Config, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUsePreciseExclusiveBounds : 1;                    // 0x043C(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, Config, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bBuildOnBeginPlay : 1;                             // 0x043C(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_43D[0x3];                                      // 0x043D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSVOQuerySettings                      DefaultQuerySettings;                              // 0x0440(0x0030)(Edit, Config, NativeAccessSpecifierPublic)
	uint8                                         bDrawOctreeNodes : 1;                              // 0x0470(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDrawOctreeSubNodes : 1;                           // 0x0470(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDrawOnlyOverlappedSubNodes : 1;                   // 0x0470(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bColourByConnected : 1;                            // 0x0470(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_471[0x3];                                      // 0x0471(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         NodeMargin;                                        // 0x0474(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WireThickness;                                     // 0x0478(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bDrawNeighbourConnections : 1;                     // 0x047C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDrawSimplifiedConnections : 1;                    // 0x047C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_47D[0x3];                                      // 0x047D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         NodeCentreRadius;                                  // 0x0480(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_484[0x4];                                      // 0x0484(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              OnFlyingNavGenerationFinished;                     // 0x0488(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AFlyingNavigationData) == 0x000588, "Wrong size on AFlyingNavigationData");
static_assert(offsetof(AFlyingNavigationData, MaxDetailSize) == 0x000428, "Member 'AFlyingNavigationData::MaxDetailSize' has a wrong offset!");
static_assert(offsetof(AFlyingNavigationData, ThreadSubdivisions) == 0x000434, "Member 'AFlyingNavigationData::ThreadSubdivisions' has a wrong offset!");
static_assert(offsetof(AFlyingNavigationData, MaxThreads) == 0x000438, "Member 'AFlyingNavigationData::MaxThreads' has a wrong offset!");
static_assert(offsetof(AFlyingNavigationData, DefaultQuerySettings) == 0x000440, "Member 'AFlyingNavigationData::DefaultQuerySettings' has a wrong offset!");
static_assert(offsetof(AFlyingNavigationData, NodeMargin) == 0x000474, "Member 'AFlyingNavigationData::NodeMargin' has a wrong offset!");
static_assert(offsetof(AFlyingNavigationData, WireThickness) == 0x000478, "Member 'AFlyingNavigationData::WireThickness' has a wrong offset!");
static_assert(offsetof(AFlyingNavigationData, NodeCentreRadius) == 0x000480, "Member 'AFlyingNavigationData::NodeCentreRadius' has a wrong offset!");
static_assert(offsetof(AFlyingNavigationData, OnFlyingNavGenerationFinished) == 0x000488, "Member 'AFlyingNavigationData::OnFlyingNavGenerationFinished' has a wrong offset!");
...
public:
	...
	class UMaterialInstanceDynamic*               WireMaterial;                                      // 0x0480(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UOctreeRenderingComponent) == 0x000500, "Wrong size on UOctreeRenderingComponent");
static_assert(offsetof(UOctreeRenderingComponent, WireMaterial) == 0x000480, "Member 'UOctreeRenderingComponent::WireMaterial' has a wrong offset!");
