...
static_assert(sizeof(FQosRegionInfo) == 0x000030, "Wrong size on FQosRegionInfo");
...
static_assert(offsetof(FRegionQosInstance, DatacenterOptions) == 0x000030, "Member 'FRegionQosInstance::DatacenterOptions' has a wrong offset!");
