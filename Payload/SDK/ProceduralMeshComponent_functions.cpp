...
// TArray<struct FVector2D>                UVs                                                    (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// TArray<struct FProcMeshTangent>         Tangents                                               (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// TArray<struct FLinearColor>             Colors                                                 (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UKismetProceduralMeshLibrary::GetSectionFromProceduralMesh(class UProceduralMeshComponent* InProcMesh, int32 SectionIndex, TArray<struct FVector>* Vertices, TArray<int32>* Triangles, TArray<struct FVector>* Normals, TArray<struct FVector2D>* UVs, TArray<struct FProcMeshTangent>* Tangents, TArray<struct FLinearColor>* Colors)
{
	static class UFunction* Func = nullptr;
...
// TArray<struct FProcMeshTangent>         Tangents                                               (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// TArray<struct FColor>                   Colors                                                 (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
void UKismetProceduralMeshLibrary::GetSectionFromStaticMesh(class UStaticMesh* InMesh, int32 LODIndex, int32 SectionIndex, TArray<struct FVector>* Vertices, TArray<int32>* Triangles, TArray<struct FVector>* Normals, TArray<struct FVector2D>* UVs, TArray<struct FVector2D>* UVs1, TArray<struct FVector2D>* UVs2, TArray<struct FVector2D>* UVs3, TArray<struct FProcMeshTangent>* Tangents, TArray<struct FColor>* Colors)
{
	...
	if (UVs1 != nullptr)
		*UVs1 = std::move(Parms.UVs1);

	if (UVs2 != nullptr)
		*UVs2 = std::move(Parms.UVs2);

	if (UVs3 != nullptr)
		*UVs3 = std::move(Parms.UVs3);
