...
static_assert(alignof(FCommonInputActionDataBase) == 0x000008, "Wrong alignment on FCommonInputActionDataBase");
static_assert(sizeof(FCommonInputActionDataBase) == 0x000280, "Wrong size on FCommonInputActionDataBase");
...
static_assert(offsetof(FCommonInputActionDataBase, KeyboardInputTypeInfo) == 0x000038, "Member 'FCommonInputActionDataBase::KeyboardInputTypeInfo' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, DefaultGamepadInputTypeInfo) == 0x0000E0, "Member 'FCommonInputActionDataBase::DefaultGamepadInputTypeInfo' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, GamepadInputOverrides) == 0x000188, "Member 'FCommonInputActionDataBase::GamepadInputOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, TouchInputTypeInfo) == 0x0001D8, "Member 'FCommonInputActionDataBase::TouchInputTypeInfo' has a wrong offset!");
