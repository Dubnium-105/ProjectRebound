...
// Function Lobby.LobbyBeaconPlayerState.OnRep_DisplayName
// (Final, Native, Protected)

void ALobbyBeaconPlayerState::OnRep_DisplayName()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LobbyBeaconPlayerState", "OnRep_DisplayName");
