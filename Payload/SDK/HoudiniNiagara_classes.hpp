...
static_assert(sizeof(UHoudiniPointCache) == 0x0000E8, "Wrong size on UHoudiniPointCache");
static_assert(offsetof(UHoudiniPointCache, Filename) == 0x000028, "Member 'UHoudiniPointCache::Filename' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, NumberOfSamples) == 0x000038, "Member 'UHoudiniPointCache::NumberOfSamples' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, NumberOfAttributes) == 0x00003C, "Member 'UHoudiniPointCache::NumberOfAttributes' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, NumberOfPoints) == 0x000040, "Member 'UHoudiniPointCache::NumberOfPoints' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, NumberOfFrames) == 0x000044, "Member 'UHoudiniPointCache::NumberOfFrames' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, FirstFrame) == 0x000048, "Member 'UHoudiniPointCache::FirstFrame' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, LastFrame) == 0x00004C, "Member 'UHoudiniPointCache::LastFrame' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, MinSampleTime) == 0x000050, "Member 'UHoudiniPointCache::MinSampleTime' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, MaxSampleTime) == 0x000054, "Member 'UHoudiniPointCache::MaxSampleTime' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, SourceCSVTitleRow) == 0x000058, "Member 'UHoudiniPointCache::SourceCSVTitleRow' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, AttributeArray) == 0x000068, "Member 'UHoudiniPointCache::AttributeArray' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, FloatSampleData) == 0x000080, "Member 'UHoudiniPointCache::FloatSampleData' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, SpawnTimes) == 0x000090, "Member 'UHoudiniPointCache::SpawnTimes' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, LifeValues) == 0x0000A0, "Member 'UHoudiniPointCache::LifeValues' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, PointTypes) == 0x0000B0, "Member 'UHoudiniPointCache::PointTypes' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, SpecialAttributeIndexes) == 0x0000C0, "Member 'UHoudiniPointCache::SpecialAttributeIndexes' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, PointValueIndexes) == 0x0000D0, "Member 'UHoudiniPointCache::PointValueIndexes' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, UseCustomCSVTitleRow) == 0x0000E0, "Member 'UHoudiniPointCache::UseCustomCSVTitleRow' has a wrong offset!");
static_assert(offsetof(UHoudiniPointCache, FileType) == 0x0000E1, "Member 'UHoudiniPointCache::FileType' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceHoudini) == 0x000040, "Wrong size on UNiagaraDataInterfaceHoudini");
static_assert(offsetof(UNiagaraDataInterfaceHoudini, HoudiniPointCacheAsset) == 0x000038, "Member 'UNiagaraDataInterfaceHoudini::HoudiniPointCacheAsset' has a wrong offset!");
