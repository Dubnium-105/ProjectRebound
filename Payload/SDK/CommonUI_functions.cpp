...
void UCommonActionWidget::HandleInputMethodChanged(ECommonInputType InInputType)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("CommonActionWidget", "HandleInputMethodChanged");

	Params::CommonActionWidget_HandleInputMethodChanged Parms{};
...
const TArray<class FName> UCommonVisibilityWidgetBase::GetRegisteredPlatforms()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("CommonVisibilityWidgetBase", "GetRegisteredPlatforms");

	Params::CommonVisibilityWidgetBase_GetRegisteredPlatforms Parms{};
