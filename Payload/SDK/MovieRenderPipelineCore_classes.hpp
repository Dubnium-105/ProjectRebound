...
static_assert(sizeof(UMoviePipeline) == 0x0002E0, "Wrong size on UMoviePipeline");
...
static_assert(offsetof(UMoviePipeline, DebugWidgetClass) == 0x0002A0, "Member 'UMoviePipeline::DebugWidgetClass' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, CurrentJob) == 0x0002A8, "Member 'UMoviePipeline::CurrentJob' has a wrong offset!");
...
static_assert(sizeof(AMoviePipelineGameMode) == 0x0002C0, "Wrong size on AMoviePipelineGameMode");
...
public:
	...
	uint8                                         Pad_69[0x9F];                                      // 0x0069(0x009F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoviePipelineExecutorShot) == 0x000130, "Wrong size on UMoviePipelineExecutorShot");
...
static_assert(offsetof(UMoviePipelineExecutorShot, Progress) == 0x0000E8, "Member 'UMoviePipelineExecutorShot::Progress' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, StatusMessage) == 0x0000F0, "Member 'UMoviePipelineExecutorShot::StatusMessage' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverrideConfig) == 0x000100, "Member 'UMoviePipelineExecutorShot::ShotOverrideConfig' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverridePresetOrigin) == 0x000108, "Member 'UMoviePipelineExecutorShot::ShotOverridePresetOrigin' has a wrong offset!");
...
static_assert(sizeof(UMoviePipelineExecutorJob) == 0x0000E0, "Wrong size on UMoviePipelineExecutorJob");
...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x000260, "Wrong size on UMovieRenderDebugWidget");
