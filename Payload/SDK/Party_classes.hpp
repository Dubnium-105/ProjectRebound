...
public:
	...
	uint8                                         Pad_1A8[0x118];                                    // 0x01A8(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USocialParty) == 0x0002C0, "Wrong size on USocialParty");
...
public:
	...
	uint8                                         Pad_E0[0x118];                                     // 0x00E0(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USocialToolkit) == 0x0001F8, "Wrong size on USocialToolkit");
