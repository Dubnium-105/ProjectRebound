...
public:
	...
	static void GetSectionFromProceduralMesh(class UProceduralMeshComponent* InProcMesh, int32 SectionIndex, TArray<struct FVector>* Vertices, TArray<int32>* Triangles, TArray<struct FVector>* Normals, TArray<struct FVector2D>* UVs, TArray<struct FProcMeshTangent>* Tangents, TArray<struct FLinearColor>* Colors);
	static void GetSectionFromStaticMesh(class UStaticMesh* InMesh, int32 LODIndex, int32 SectionIndex, TArray<struct FVector>* Vertices, TArray<int32>* Triangles, TArray<struct FVector>* Normals, TArray<struct FVector2D>* UVs, TArray<struct FVector2D>* UVs1, TArray<struct FVector2D>* UVs2, TArray<struct FVector2D>* UVs3, TArray<struct FProcMeshTangent>* Tangents, TArray<struct FColor>* Colors);
...
public:
	...
	TArray<struct FProcMeshSection>               ProcMeshSections;                                  // 0x0490(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FKConvexElem>                   CollisionConvexElems;                              // 0x04A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FBoxSphereBounds                       LocalBounds;                                       // 0x04B0(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4CC[0x4];                                      // 0x04CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBodySetup*>                     AsyncBodySetupQueue;                               // 0x04D0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
