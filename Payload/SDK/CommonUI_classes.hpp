...
public:
	...
	bool                                          bDisplayInActionBar;                               // 0x028A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bSupportsActivationFocus;                          // 0x028B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsModal;                                          // 0x028C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAutoRestoreFocus;                                 // 0x028D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_28E[0x6];                                      // 0x028E(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bSetVisibilityOnActivated;                         // 0x0294(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ESlateVisibility                              ActivatedVisibility;                               // 0x0295(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bSetVisibilityOnDeactivated;                       // 0x0296(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ESlateVisibility                              DeactivatedVisibility;                             // 0x0297(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UCommonActivatableWidget, bDisplayInActionBar) == 0x00028A, "Member 'UCommonActivatableWidget::bDisplayInActionBar' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bSupportsActivationFocus) == 0x00028B, "Member 'UCommonActivatableWidget::bSupportsActivationFocus' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bIsModal) == 0x00028C, "Member 'UCommonActivatableWidget::bIsModal' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bAutoRestoreFocus) == 0x00028D, "Member 'UCommonActivatableWidget::bAutoRestoreFocus' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bSetVisibilityOnActivated) == 0x000294, "Member 'UCommonActivatableWidget::bSetVisibilityOnActivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, ActivatedVisibility) == 0x000295, "Member 'UCommonActivatableWidget::ActivatedVisibility' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bSetVisibilityOnDeactivated) == 0x000296, "Member 'UCommonActivatableWidget::bSetVisibilityOnDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, DeactivatedVisibility) == 0x000297, "Member 'UCommonActivatableWidget::DeactivatedVisibility' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_13A[0x1E];                                     // 0x013A(0x001E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TMulticastInlineDelegate<void(class UCommonButtonBase* Button, bool Selected)> OnSelectedChangedBase;                             // 0x0300(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonBase* Button)> OnButtonBaseClicked;                               // 0x0310(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonBase* Button)> OnButtonBaseDoubleClicked;                         // 0x0320(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonBase* Button)> OnButtonBaseHovered;                               // 0x0330(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonBase* Button)> OnButtonBaseUnhovered;                             // 0x0340(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_356[0x32];                                     // 0x0356(0x0032)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonButtonBase) == 0x000BA0, "Wrong size on UCommonButtonBase");
...
static_assert(offsetof(UCommonButtonBase, bIsPersistentBinding) == 0x000354, "Member 'UCommonButtonBase::bIsPersistentBinding' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, InputModeOverride) == 0x000355, "Member 'UCommonButtonBase::InputModeOverride' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, SingleMaterialStyleMID) == 0x000388, "Member 'UCommonButtonBase::SingleMaterialStyleMID' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, NormalStyle) == 0x000390, "Member 'UCommonButtonBase::NormalStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, SelectedStyle) == 0x000608, "Member 'UCommonButtonBase::SelectedStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, DisabledStyle) == 0x000880, "Member 'UCommonButtonBase::DisabledStyle' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, InputActionWidget) == 0x000B98, "Member 'UCommonButtonBase::InputActionWidget' has a wrong offset!");
...
static_assert(sizeof(UCommonBoundActionButton) == 0x000BB0, "Wrong size on UCommonBoundActionButton");
static_assert(offsetof(UCommonBoundActionButton, Text_ActionName) == 0x000BA0, "Member 'UCommonBoundActionButton::Text_ActionName' has a wrong offset!");
...
{
public:
	TSubclassOf<class UCommonTextStyle>           Style;                                             // 0x02A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UCommonTextScrollStyle>     ScrollStyle;                                       // 0x02B0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonTextBlock) == 0x0002D0, "Wrong size on UCommonTextBlock");
static_assert(offsetof(UCommonTextBlock, Style) == 0x0002A8, "Member 'UCommonTextBlock::Style' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, ScrollStyle) == 0x0002B0, "Member 'UCommonTextBlock::ScrollStyle' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, bDisplayAllCaps) == 0x0002B8, "Member 'UCommonTextBlock::bDisplayAllCaps' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, bAutoCollapseWithEmptyText) == 0x0002B9, "Member 'UCommonTextBlock::bAutoCollapseWithEmptyText' has a wrong offset!");
static_assert(offsetof(UCommonTextBlock, MobileFontSizeMultiplier) == 0x0002BC, "Member 'UCommonTextBlock::MobileFontSizeMultiplier' has a wrong offset!");
...
static_assert(sizeof(UCommonDateTimeTextBlock) == 0x000310, "Wrong size on UCommonDateTimeTextBlock");
...
public:
	...
	TMulticastInlineDelegate<void(class UCommonNumericTextBlock* NumericTextBlock, bool HadCompleted)> OnInterpolationEndedEvent;                         // 0x0300(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCommonNumericTextBlock) == 0x000370, "Wrong size on UCommonNumericTextBlock");
static_assert(offsetof(UCommonNumericTextBlock, OnInterpolationStartedEvent) == 0x0002D0, "Member 'UCommonNumericTextBlock::OnInterpolationStartedEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, OnInterpolationUpdatedEvent) == 0x0002E0, "Member 'UCommonNumericTextBlock::OnInterpolationUpdatedEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, OnOutroEvent) == 0x0002F0, "Member 'UCommonNumericTextBlock::OnOutroEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, OnInterpolationEndedEvent) == 0x000300, "Member 'UCommonNumericTextBlock::OnInterpolationEndedEvent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, CurrentNumericValue) == 0x000310, "Member 'UCommonNumericTextBlock::CurrentNumericValue' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, NumericType) == 0x000314, "Member 'UCommonNumericTextBlock::NumericType' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, FormattingSpecification) == 0x000318, "Member 'UCommonNumericTextBlock::FormattingSpecification' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, EaseOutInterpolationExponent) == 0x00032C, "Member 'UCommonNumericTextBlock::EaseOutInterpolationExponent' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, InterpolationUpdateInterval) == 0x000330, "Member 'UCommonNumericTextBlock::InterpolationUpdateInterval' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, PostInterpolationShrinkDuration) == 0x000334, "Member 'UCommonNumericTextBlock::PostInterpolationShrinkDuration' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, PerformSizeInterpolation) == 0x000338, "Member 'UCommonNumericTextBlock::PerformSizeInterpolation' has a wrong offset!");
static_assert(offsetof(UCommonNumericTextBlock, IsPercentage) == 0x000339, "Member 'UCommonNumericTextBlock::IsPercentage' has a wrong offset!");
...
static_assert(sizeof(UCommonRotator) == 0x000BF8, "Wrong size on UCommonRotator");
static_assert(offsetof(UCommonRotator, OnRotated) == 0x000BB0, "Member 'UCommonRotator::OnRotated' has a wrong offset!");
static_assert(offsetof(UCommonRotator, MyText) == 0x000BD8, "Member 'UCommonRotator::MyText' has a wrong offset!");
