...
public:
	...
	TArray<struct FVector2D>                      UVs;                                               // 0x0040(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FProcMeshTangent>               Tangents;                                          // 0x0050(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FLinearColor>                   Colors;                                            // 0x0060(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(KismetProceduralMeshLibrary_GetSectionFromProceduralMesh) == 0x000070, "Wrong size on KismetProceduralMeshLibrary_GetSectionFromProceduralMesh");
...
static_assert(offsetof(KismetProceduralMeshLibrary_GetSectionFromProceduralMesh, Colors) == 0x000060, "Member 'KismetProceduralMeshLibrary_GetSectionFromProceduralMesh::Colors' has a wrong offset!");
...
public:
	...
	TArray<struct FColor>                         Colors;                                            // 0x0090(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(KismetProceduralMeshLibrary_GetSectionFromStaticMesh) == 0x0000A0, "Wrong size on KismetProceduralMeshLibrary_GetSectionFromStaticMesh");
...
static_assert(offsetof(KismetProceduralMeshLibrary_GetSectionFromStaticMesh, Colors) == 0x000090, "Member 'KismetProceduralMeshLibrary_GetSectionFromStaticMesh::Colors' has a wrong offset!");
