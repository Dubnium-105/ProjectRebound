...
void ProcessEventHookClient(UObject* Object, UFunction* Function, void* Parms) {
    ...
    if (functionName.contains("PBFieldModManager.SelectCharacter"))
    {
        ...
        {
            if (gLoadoutManager)
                gLoadoutManager->RememberMenuSelectedRole(selectParms->InCharacterID);
        }
    }
    else if (functionName.contains("PBFieldModWidget.OnSelectCharacter"))
    {
        ...
        {
            if (gLoadoutManager)
                gLoadoutManager->RememberMenuSelectedRole(selectParms->InCharacter);
        }
    }
...
// LoadoutManager implementation moved to Payload/LoadoutManager.cpp.
