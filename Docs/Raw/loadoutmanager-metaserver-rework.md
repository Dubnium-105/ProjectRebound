...
#### `Metaserver/game/definitionIndex.js`
...
#### `Metaserver/game/loadoutStore.js`
...
#### `Metaserver/start-metaserver.bat`
...
#### `ProjectReboundMainDLL/Loadout/MetaserverClient.h/cpp`
...
#### `ProjectReboundMainDLL/Loadout/LoadoutSerializer.h/cpp`
...
#### `ProjectReboundMainDLL/Loadout/LoadoutApplication.h/cpp`
...
| 组件 | 说明 |
|------|------|
| `Metaserver/game/definitions/*.json` | 物品定义数据源不变 |
| `Metaserver/game/proto/*.proto` | protobuf 协议定义不变 |
