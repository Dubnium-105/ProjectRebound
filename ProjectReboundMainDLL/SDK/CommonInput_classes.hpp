...
public:
	...
	TMulticastInlineDelegate<void(ECommonInputType bNewInputType)> OnInputMethodChanged;                              // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCommonInputSubsystem, OnInputMethodChanged) == 0x000048, "Member 'UCommonInputSubsystem::OnInputMethodChanged' has a wrong offset!");
