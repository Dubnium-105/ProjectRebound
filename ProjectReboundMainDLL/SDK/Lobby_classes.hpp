...
{
public:
	class FText                                   DisplayName;                                       // 0x0220(0x0018)(Net, RepNotify, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_298[0x60];                                     // 0x0298(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ALobbyBeaconPlayerState) == 0x0002F8, "Wrong size on ALobbyBeaconPlayerState");
